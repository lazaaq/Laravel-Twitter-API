...
<div class="container mt-5 content">
  <div id="byid">
    ...
    <form action="{{ route('users-lookup.byId') }}" method="post">
      @csrf
  ...
  <div id="byids">
    ...
    <form action="{{ route('users-lookup.byIds') }}" method="post">
      @csrf
  ...
  <div id="byUsername">
    ...
    <form action="{{ route('users-lookup.byUsername') }}" method="post">
      @csrf
  ...
  <div id="byUsernames">
    <h2>Get Users By Username</h2>
    <form action="{{ route('users-lookup.byUsernames') }}" method="post">
      @csrf
